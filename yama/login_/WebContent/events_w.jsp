	...
	<!-- Modal -->
		...
		<div class="container-fluid" style="background-color: #19191a" >
              ...
              <li class="nav-item" style="margin-left: 2.7em;height: 3.7em; padding-top: 0.3em;"><a class="nav-link" href="layout_w.jsp"><strong>Layout</strong></a></li>
      				<li class="nav-item" style="margin-left: 2.7em;height: 3.7em; padding-top: 0.3em;"><a class="nav-link" href="events_w.jsp"><strong>Events</strong></a></li>
...
%>
<h2 align="center"><font><strong>Upcoming Events</strong></font></h2>
...
String sql="SELECT date ,Event from temp1 where DATEDIFF(now(), date) <0;";
...
<button data-toggle="modal" data-target="#register" class="btn btn-outline-danger" role="button" aria-pressed="true">Register For Event</button>
  ...
  <div class="modal fade" id="sign" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <div class="modal-content" >
     <div class="modal-header">
       <h5 class="modal-title" id="exampleModalCenterTitle">Register for Event</h5>
...
<div class="modal fade" id="register" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
   ...
   <div class="modal-content" >
    <div class="modal-header">
      <center><h5 class="modal-title" id="exampleModalCenterTitle">Register for Event</h5></center>
       <button type="button" class="close" data-dismiss="modal" aria-label="Close">
         <span aria-hidden="true">&times;</span>
       </button>
     </div>
     ...
     Name of Organizer :
         <input type="text" name="Organizer" style="width: 10em" required ><br><br>
         <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
     Event Details : 
        <input list="event_n" name="event_n">
        <datalist id="event_n">
          <option value="Movie Promotion">
         ...
         Phone Number :
         <input type="number" name="Contact" style="width: 8.6em" required><br><br>
         <i class="fa fa-calendar" aria-hidden="true"></i>
          Date of Event :
         <input type="date" min="2018-10-13"  max="2018-12-13" name="date"> <br><br>
         <input type="submit" type="button" class="btn btn-secondary" style="float: right;">
       </form>
     </div>
     </div>
