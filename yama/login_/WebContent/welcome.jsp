...
<!-- <p style="float:right;color:black;" id=>Welcome ${username}</p>
 <form action="Logout">
		...
		<div class="container-fluid" style="background-color: #19191a" >
  			<nav class="navbar navbar-expand md sticky-top -material" id="navbar" >
  				<ul class="nav navbar-nav">
      				<li class="nav-item" style="margin-left: 17em;height: 3.7em;padding-top: 0.4em"><a class="nav-link" href="welcome_w.jsp"><strong>Home</strong></a></li>
...
<div class="parallax" style="background-image: url('event.png');"></div>
